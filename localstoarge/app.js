...
function renderOrder() {
    ...
    if (banana[b].isHot === true) {
        hot = "hot"
    } else {
        hot = "cold";
    }

    parElement.textContent = `this customer ${banana[b].cusName} he order the following ${banana[b].cupSize} with ${banana[b].milkType} and he prefare is ${hot} in ${banana[b].drinkType}  `;
